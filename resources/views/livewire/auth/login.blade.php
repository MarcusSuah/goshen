...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Log in to your account')" :description="__('Use your email and password below to log in')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        <!-- Email Address -->
        <flux:input wire:model="authIdentifier" :label="__('Login with your Phone, Username or Email address')"
            type="text" required autofocus placeholder="email@example.com, johndoe, 123456788" />
